...
<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="8000">
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="item active">
      <img class="img-responsive center-block" src="resources/subteams/wetlab1440x470.jpg" alt="wetlab">
    ...
    <div class="item">
      <img class="img-responsive center-block" src="resources/subteams/business1440x470.jpg" alt="business">
      <div class='subteam-blerb'>
        <h2>Business</h2>
    ...
    <div class="item">
      <img class="img-responsive center-block" src="resources/subteams/drylab1440x470.jpg" alt="drylab">
      <div class='subteam-blerb'>
    ...
    <div class="item">
      <img class="img-responsive center-block" src="resources/subteams/outreach1440x470.jpg" alt="outreach">
      <div class='subteam-blerb'>
